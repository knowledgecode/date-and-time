...
Z:function(a){a=a.utc?0:a.getTimezoneOffset()/.6;return(0<a?"-":"+")+("000"+Math.abs(a-a%100*.4)).slice(-4)},post:function(a){return a}},parser:{find:function(a,c){for(var b=-1,d=0,f=0,g=a.length,e;f<g;f++)e=a[f],!c.indexOf(e)&&e.length>d&&(b=f,d=e.length);return{index:b,length:d}},MMMM:function(a){return this.parser.find(this.MMMM,a)},MMM:function(a){return this.parser.find(this.MMM,a)},A:function(a){return this.parser.find(this.A,a)},h:function(a,c){return(12===a?0:a)+12*c},pre:function(a){return a}}}};
b.format=function(a,c,p){var d=b.addMinutes(a,p?a.getTimezoneOffset():0),f=k[m],g=f.formatter;d.utc=p;return c.replace(/(\[[^\[\]]*]|\[.*\][^\[]*\]|YYYY|YY|MMM?M?|DD|HH|hh|mm|ss|SSS?|ddd?d?|.)/g,function(a){var b=g[a];return b?g.post(b.call(f,d,c)):a.replace(/\[(.*)]/,"$1")})};b.parse=function(a,c,p){var d=k[m],f=d.parser.pre(a),g=0,e,l,u=/(MMMM?|A)|(YYYY)|(SSS)|(MM|DD|HH|hh|mm|ss)|(YY|M|D|H|h|m|s|SS)|(S)|(.)/g,n={2:/^\d{1,4}/,3:/^\d{1,3}/,4:/^\d\d/,5:/^\d\d?/,6:/^\d/};for(a={Y:1970,M:1,D:1,H:0,m:0,
s:0,S:0};e=u.exec(c);){var q=0;var r=1;for(l="";!l;)l=e[++q];e=l.charAt(0);var t=f.slice(g);if(2>q){var h=d.parser[l].call(d,t,c);a[e]=h.index;"M"===e&&a[e]++;r=h.length}else if(7>q)h=(t.match(n[q])||[""])[0],a[e]=("S"===e?(h+"000").slice(0,-l.length):h)|0,r=h.length;else if(" "!==e&&e!==t[0])return NaN;if(!r)return NaN;g+=r}if(g!==f.length||!h)return NaN;a.Y+=70>a.Y?2E3:100>a.Y?1900:0;a.H=a.H||d.parser.h(a.h||0,a.A||0);c=new Date(a.Y,a.M-1,a.D,a.H,a.m,a.s,a.S);return a.Y!==c.getFullYear()||a.M-1!==
c.getMonth()||a.D!==c.getDate()||a.H!==c.getHours()||a.m!==c.getMinutes()||a.s!==c.getSeconds()||a.S!==c.getMilliseconds()?NaN:p?b.addMinutes(c,-c.getTimezoneOffset()):c};b.isValid=function(a,c){return!!b.parse(a,c)};b.addYears=function(a,c){return b.addMonths(a,12*c)};b.addMonths=function(a,c){var b=new Date(a.getTime());b.setMonth(b.getMonth()+c);return b};b.addDays=function(a,c){var b=new Date(a.getTime());b.setDate(b.getDate()+c);return b};b.addHours=function(a,c){return b.addMilliseconds(a,36E5*
c)};b.addMinutes=function(a,c){return b.addMilliseconds(a,6E4*c)};b.addSeconds=function(a,c){return b.addMilliseconds(a,1E3*c)};b.addMilliseconds=function(a,c){return new Date(a.getTime()+c)};b.subtract=function(a,c){var b=a.getTime()-c.getTime();return{toMilliseconds:function(){return b},toSeconds:function(){return b/1E3|0},toMinutes:function(){return b/6E4|0},toHours:function(){return b/36E5|0},toDays:function(){return b/864E5|0}}};b.isLeapYear=function(a){a=a.getFullYear();return!(a%4)&&!!(a%100)||
!(a%400)};b.isSameDay=function(a,c){return b.format(a,"YYYYMMDD")===b.format(c,"YYYYMMDD")};b.locale=function(a){a&&("en"!==a&&"function"===typeof require&&n&&require("./locale/"+a),m=a);return m};b.getLocales=function(a){return k[a||m]};b.setLocales=function(a,b){var c=function(a,b){var c=function(){},d;c.prototype=b;c=new c;for(d in a)a.hasOwnProperty(d)&&(c[d]=a[d]);return c},d=k[a]||k.en,f=c(b,d);b.formatter&&(f.formatter=c(b.formatter,d.formatter));b.parser&&(f.parser=c(b.parser,d.parser));k[a]=
f};"object"===typeof module&&"object"===typeof module.exports?module.exports=b:"function"===typeof define&&define.amd?define([],function(){return b}):n.date=b})(this);
