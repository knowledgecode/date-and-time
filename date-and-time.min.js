...
toSeconds:function(){return b/1E3|0},toMinutes:function(){return b/6E4|0},toHours:function(){return b/36E5|0},toDays:function(){return b/864E5|0}}};d.isLeapYear=function(a){return!(a%4)&&!!(a%100)||!(a%400)};d.isSameDay=function(a,c){return d.format(a,"YYYYMMDD")===d.format(c,"YYYYMMDD")};d.locale=function(a,c){c?p(a,{res:q,formatter:r,parser:t},c):a&&(!l[a]&&"function"===typeof require&&m&&require("./locale/"+a),h=a);return h};d.extend=function(a){p(h,l[h],a)};d.plugin=function(a,c){g[a]=g[a]||c;
c||(!g[a]&&"function"===typeof require&&m&&require("./plugin/"+a),g[a]&&d.extend(g[a]))};d.locale(h,{});"object"===typeof module&&"object"===typeof module.exports?module.exports=d:"function"===typeof define&&define.amd?define([],function(){return d}):m.date=d})(this);
