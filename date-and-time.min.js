...
var c="-";0>=a&&(c="+",a=-a);return c+("000"+(100*(a/60|0)+a%60)).slice(-4)},post:function(a){return a}},parsers:{h:function(a,c){return(12===a?0:a)+12*c},pre:function(a){return a}}}},m=function(a,c){for(var b=0,h=a.length;b<h&&0!==c(a[b],b);b++);},p=function(a,c){var b=0,h,e,d,l=c.match(/YYYY|YY|MMM?M?|DD|HH|hh|mm|ss|SSS?|./g),k={Y:0,M:1,D:1,A:0,H:0,h:0,m:0,s:0,S:0};a=f[g].parsers.pre(a);m(l,function(c){h=c.charAt(0);e=c.length;d=a.slice(b);/^(YYYY|YY|MM|DD|HH|hh|mm|ss|SS?S?)$/.test(c)?(k[h]=d.slice(0,
e)|0,"YY"===c&&(k.Y+=70>k.Y?2E3:1900)):/^(M|D|H|h|m|s)$/.test(c)?(d=(d.match(/^\d\d?/)||[""])[0],e=d.length,k[h]=d|0):/^(MMMM?|A)$/.test(c)&&m(f[g][c],function(a,b){if(!d.indexOf(a))return k[h]="M"===h?b+1:b,e=a.length,0});b+=e});return k};d.format=function(a,c,b){var d=c.match(/(\[[^\[\]]*]|\[.*\][^\[]*\]|YYYY|YY|MMM?M?|DD|HH|hh|mm|ss|SSS?|ddd?d?|.)/g)||[],e=new Date(a.getTime()+(b?6E4*a.getTimezoneOffset():0)),n=f[g],l=n.formats;e.utc=b;m(d,function(a,b){d[b]=(l[a]||function(){}).call(n,e)||a.replace(/\[(.*)]/,
"$1")});return l.post(d.join(""))};d.parse=function(a,c,b){a=p(a,c);a=new Date(a.Y,a.M-1,a.D,a.H||f[g].parsers.h(a.h,a.A),a.m,a.s,a.S);return b?new Date(a.getTime()-6E4*a.getTimezoneOffset()):a};d.isValid=function(a,c){var b=p(a,c),d=b.H||f[g].parsers.h(b.h,b.A),e=new Date(b.Y,b.M-1,b.D,d,b.m,b.s,b.S);return b.Y===e.getFullYear()&&b.M-1===e.getMonth()&&b.D===e.getDate()&&d===e.getHours()&&b.m===e.getMinutes()&&b.s===e.getSeconds()&&b.S===e.getMilliseconds()};d.addYears=function(a,c){var b=new Date(a.getTime());
...
return{toMilliseconds:function(){return b},toSeconds:function(){return b/1E3|0},toMinutes:function(){return b/6E4|0},toHours:function(){return b/36E5|0},toDays:function(){return b/864E5|0}}};d.isLeapYear=function(a){a=a.getFullYear();return!(a%4)&&!!(a%100)||!(a%400)};d.locale=function(a){a&&("object"===typeof module&&"object"===typeof module.exports&&require("./locale/"+a),g=a);return g};d.setLocales=function(a,c){var b=function(a,b){var c=function(){},d;c.prototype=b;c=new c;for(d in a)a.hasOwnProperty(d)&&
(c[d]=a[d]);return c},d=f[a]||f.en,e=b(c,d);c.formats&&(e.formats=b(c.formats,d.formats));c.parsers&&(e.parsers=b(c.parsers,d.parsers));f[a]=e};"object"===typeof module&&"object"===typeof module.exports?module.exports=d:"function"===typeof define&&define.amd?define([],function(){return d}):q.date=d})(this);
